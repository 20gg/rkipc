...
```mermaid
graph TB
	VI_0[VI_0_3840*2160]--FBC-->VPSS_GRP_0(VPSS_GRP_0_GPU_3840*2160)
	VI_1[VI_1_3840*2160]-.switchable.->VPSS_GRP_0
	VPSS_GRP_0--NV12-->VPSS_GRP_1(VPSS_GRP_1_GPU_1920*1088)
	VPSS_GRP_1--NV12-->VENC_1_1920*1088-->RTSP/RTMP_1
	VPSS_GRP_1--NV12_CHN1-->RGA_640*640--RGB-->RKNN_NPU[yolo26n_NPU_Core0+1]
	VPSS_GRP_0--NV12-->VGS--NV12-->VENC_3_JPEG_3840*2160
	VI_0--FBC-->VPSS_GRP_3(VPSS_GRP_3_GPU_3840*2160)--NV12-->VO_HDMI_1920*1088
	VI_1-.switchable.->VPSS_GRP_3
```
